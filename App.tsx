        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {data.blogPosts.map((post) => (
              <article key={post.id} className="group cursor-pointer bg-secondary rounded-2xl border border-slate-700 overflow-hidden hover:border-accent/50 transition-all duration-300 hover:shadow-xl">
