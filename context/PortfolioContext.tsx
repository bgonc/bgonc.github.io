...
const LABELS_EN: Labels = {
  ...
  sayHello: 'Say Hello',
  footer: 'Built with React, Tailwind & Gemini.',
...
const LABELS_PT: Labels = {
  ...
  sayHello: 'Diga Olá',
  footer: 'Criado com React, Tailwind & Gemini.',
...
export const PortfolioProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const resetData = () => {
    ...
    resetSession(defaultData, language);
  };
